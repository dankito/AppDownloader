...
public class ApacheHttpClientWebClient implements IWebClient {
  ...
  protected void get(RequestParameters parameters, RequestCallback callback) {
    try {
      ...
      callback.completed(new WebClientResponse(true, responseString));
    } catch(Exception e) {
  ...
  protected void post(RequestParameters parameters, RequestCallback callback) {
    try {
